...
/**
 * <p>Original spec-file module name: uimockup</p>
 * <pre>
 * A KBase module: uimockup
 * </pre>
 */
public class UimockupClient {
     ...
     * validity.
     */
    public UimockupClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public UimockupClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public UimockupClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    protected <T> JobState<T> _checkJob(String jobId, TypeReference<List<JobState<T>>> retType) throws IOException, JsonClientException {
        ...
        args.add(jobId);
        List<JobState<T>> res = caller.jsonrpcCall("uimockup._check_job", args, retType, true, true);
        return res.get(0);
    }

    /**
     * <p>Original spec-file function name: Hisat2Call</p>
     * <pre>
     * </pre>
     * @param   params   instance of type {@link us.kbase.uimockup.Hisat2Params Hisat2Params}
     * @return   instance of type {@link us.kbase.uimockup.ResultsToReport ResultsToReport}
     * @throws IOException if an IO exception occurs
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    protected String _hisat2CallSubmit(Hisat2Params params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<List<String>> retType = new TypeReference<List<String>>() {};
        List<String> res = caller.jsonrpcCall("uimockup._Hisat2Call_submit", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public ResultsToReport hisat2Call(Hisat2Params params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        String jobId = _hisat2CallSubmit(params, jsonRpcContext);
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("uimockup.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
